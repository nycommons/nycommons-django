# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-08-03 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='elephantblog.Category')),
            ],
            options={
                'ordering': ['title'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=100, unique_for_date='published_on', verbose_name='slug')),
                ('published_on', models.DateTimeField(blank=True, db_index=True, default=django.utils.timezone.now, help_text='Will be filled in automatically when entry gets published.', null=True, verbose_name='published on')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blogentries', to=settings.AUTH_USER_MODEL, verbose_name='author')),
                ('categories', models.ManyToManyField(blank=True, null=True, related_name='blogentries', to='elephantblog.Category', verbose_name='categories')),
                ('translation_of', models.ForeignKey(blank=True, help_text='Leave this empty for entries in the primary language.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='elephantblog.Entry', verbose_name='translation of')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediafilecontent_set', to='elephantblog.Entry')),
            ],
            options={
                'ordering': ['ordering'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='richtextcontent_set', to='elephantblog.Entry')),
            ],
            options={
                'ordering': ['ordering'],
                'abstract': False,
