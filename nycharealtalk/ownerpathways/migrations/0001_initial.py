# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-08-16 23:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'ownerpathways_ownerpathway_mediafilecontent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specific_private_owners', models.ManyToManyField(blank=True, help_text='This pathway applies to lots with these private owners.', related_name='_ownerpathway_specific_private_owners_+', to='owners.Owner')),
                ('specific_public_owners', models.ManyToManyField(blank=True, help_text='This pathway applies to lots with these public owners.', related_name='_ownerpathway_specific_public_owners_+', to='owners.Owner')),
                ('translation_of', models.ForeignKey(blank=True, help_text='Leave this empty for entries in the primary language.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='ownerpathways.OwnerPathway', verbose_name='translation of')),
            ],
            options={
                'verbose_name': 'Owner details',
                'verbose_name_plural': 'Owner details',
            },
            bases=(caching.base.CachingMixin, feincms.module.mixins.ContentModelMixin, models.Model, feincms.extensions.base.ExtensionsMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='richtextcontent_set', to='ownerpathways.OwnerPathway')),
            ],
            options={
                'ordering': ['ordering'],
                'abstract': False,
                'verbose_name_plural': 'rich texts',
                'db_table': 'ownerpathways_ownerpathway_richtextcontent',
        ...
        migrations.AddField(
            ...
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediafilecontent_set', to='ownerpathways.OwnerPathway'),
        ),
    ]
