    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'organizingpathways_organizingpathway_mediafilecontent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specific_private_owners', models.ManyToManyField(blank=True, help_text='This pathway applies to lots with these private owners.', related_name='_organizingpathway_specific_private_owners_+', to='owners.Owner')),
                ('specific_public_owners', models.ManyToManyField(blank=True, help_text='This pathway applies to lots with these public owners.', related_name='_organizingpathway_specific_public_owners_+', to='owners.Owner')),
                ('translation_of', models.ForeignKey(blank=True, help_text='Leave this empty for entries in the primary language.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='organizingpathways.OrganizingPathway', verbose_name='translation of')),
            ],
            options={
                'ordering': ('order', 'name'),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='richtextcontent_set', to='organizingpathways.OrganizingPathway')),
            ],
            options={
                'ordering': ['ordering'],
                'abstract': False,
                'verbose_name_plural': 'rich texts',
                'db_table': 'organizingpathways_organizingpathway_richtextcontent',
        ...
        migrations.AddField(
            ...
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediafilecontent_set', to='organizingpathways.OrganizingPathway'),
        ),
    ]
