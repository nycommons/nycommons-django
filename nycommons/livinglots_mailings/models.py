...
class Mailing(models.Model):
    ...
    duplicate_handling = models.CharField(
        ...
        default='each',
        help_text=_('How should we handle mailings that are going to go to the '
    ...
    last_checked = models.DateTimeField(
        _('last checked'),
        help_text=_('The last time this mailing was sent.'),
    )
...
class DaysAfterAddedMixin(models.Model):
    ...
    days_after_added = models.IntegerField(
        _('days after added'),
        help_text=_('The number of days after an entity is added that they '
...
class DeliveryRecord(models.Model):
    ...
    sent = models.BooleanField(
        _('sent'),
        default=False,
        help_text=_('The mailing was sent'),
    )

    recorded = models.DateTimeField(
        _('recorded'),
        auto_now_add=True,
        help_text=_('When this mailing was recorded'),
    )

    mailing = models.ForeignKey(
        Mailing,
        help_text=_('The mailing that was sent'),
    )
